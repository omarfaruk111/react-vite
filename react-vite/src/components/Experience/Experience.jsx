    ...
    return (
        <div className='bg-slate-900 p-5 flex flex-row gap-10 rounded-md'>
            <div className='w-1/4 relative'>
                <div className='absolute top-0 bottom-0 z-40 flex flex-col justify-center p-6'>
                    <h1 className='text-white text-2xl font-medium font-rubik'>{item.job.position}</h1>
                    <h2 className='text-white text-lg font-medium font-rubik py-2'>{item.job.year}</h2>
                    <h3 className='text-white text-sm font-normal font-rubik'>{item.job.job_type}</h3>
                </div>
