...
const Blog = () => {
  return (
    <div id='blog' className='project bg-secondary pb-32 md:pb-24 sm:pb-20 lg:pl-4 lg:pr-4'>
    ...
    <div className="flex flex-col text-center">
          ...
          LASTET NEWS & <span className="bg-clip-text text-transparent bg-gradient-236 from-gradientColor1 to-gradientColor2">BLOGS</span>
          </h2>
