    ...
    <div className='bg-secondary pt-32 pb-32 lg:pl-4 lg:pr-4'>
        <div className="container m-auto flex flex-row md:flex-col">
            ...
            <div className="w-full xl:w-1/2 lg:w-1/2 md:w-full flex flex-col justify-center">
                <h2 className='font-oswald text-white text-5xl font-semibold sm:text-3xl'>FAILURE IS THE CONDIMENT THAT GIVES <span className='bg-clip-text text-transparent bg-gradient-to-r from-gradientColor1 to-gradientColor2'>SUCCESS</span></h2>
